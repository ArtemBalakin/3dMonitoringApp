...
import com.klipper.main.config.KafkaSseConsumer;
import com.klipper.main.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/klipper-kafka")
public class KlipperKafkaResource {

    private final Logger log = LoggerFactory.getLogger(KlipperKafkaResource.class);
    ...
    public KlipperKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
